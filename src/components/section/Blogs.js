    ...
    <Section id='blog'>
      ...
      <Container>
        ...
        <Items>
          ...
          <RoadmapItem addToRef={addToRef} title="Sales" subtext="Money management is something everyone is concerned with, from the adolescent working to get their first credit card to the entrepreneur wanting to exponentially grow their personal savings." />

          <RoadmapItem addToRef={addToRef} title="Education" subtext="Money management is something everyone is concerned with, from the adolescent working to get their first credit card to the entrepreneur wanting to exponentially grow their personal savings." />
        </Items>
      </Container>
    </Section>
  )
